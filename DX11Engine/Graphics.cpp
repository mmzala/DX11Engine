...
void Graphics::DrawTestTriangle()  // Test method
{
	namespace wrl = Microsoft::WRL;
	HRESULT hr;
	...
	// Vertex buffer (creates a 2d triangle at the center of the screen)
	const Vertex vertices[] =
	{
		{ 0.0f, 0.5f },  // Top of triangle
		{ 0.5f, -0.5f },  // Right bottom of triangle
		{ -0.5f, -0.5f }  // Left bottom of triangle
	};
	...
	// Bind render target
	pDeviceContext->OMSetRenderTargets(1u, pRenderTarget.GetAddressOf(), nullptr);
